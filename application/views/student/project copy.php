...
<!-- <form action="<?=base_url('project/addfile/'.$Id);?>" method="post" enctype="multipart/form-data" name="formaddfile" id="formaddfile" class="form-horizontal" novalidate> 
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="projectId" id="projectId" value="<?=$project_id;?>">   
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <input type="file" class="form-control" name="txt_01_cov" id="txt_01_cov">
