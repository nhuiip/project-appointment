    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-content" style="padding: 15px 0 20px;">
                ...
                <? if (count($listdata) != 0) { ?>
                    <!-- table ------------------------------------------------------------------------------------------------------->
                    <table class="table table-hover table-bordered dataTables-export" width="100%" data-filename="student-data" data-colexport="0,1,2,3,4,5,6">
                        <thead>
                            <tr>
                                <th>รหัสนักศึกษา</th>
                                <th>ชื่อ - สกุล</th>
                                ...
                                <tr class="gradeX">
                                    ...
                                    <td>
                                        <? if ($value['std_create_name'] != '0') { ?>
                                            <?= $value['std_create_name']; ?><? } ?>
                                            <small class="text-muted"><i class="fa fa-clock-o"></i> <?= DateThai($value['std_create_date']); ?> <?= date('h:i A', strtotime($value['std_create_date'])); ?></small>
                                    </td>
                                    <td>
                                        <? if ($value['std_lastedit_name'] != '0') { ?>
                                            <?= $value['std_lastedit_name']; ?>
                                        <? } ?>
                                        <small class="text-muted"><i class="fa fa-clock-o"></i> <?= DateThai($value['std_lastedit_date']); ?> <?= date('h:i A', strtotime($value['std_lastedit_date'])); ?></small>
                                    </td>
                                    <td width="10%">
                                        <div class="btn-group" style="width:100%">
                                            ...
                                            <ul class="dropdown-menu" style="width:100%">
                                                ...
                                                <li><a class="btn-reloadmeet" data-title="ส่งอีเมล์ยืนยันอีกครั้ง" data-url="<?= base_url('student/sentmailremail2/' . $value['std_id']); ?>"><i class="fa fa-arrow-circle-right"></i>&nbsp;ส่งอีเมล์ยืนยันอีกครั้ง</a></li>
