                                        ...
                                        <? if (count($listtag) != 0) { ?>
                                            <div class="col-sm-12 tooltip-demo" style="background-color: aliceblue;padding-top: 5px;padding-bottom: 5px;">
                                                <? foreach ($listtag as $key => $tag) { ?>
                                                    <span class="label label-success" style="text-transform: uppercase;margin-right:3px;background-color: <?=$tag['use_color'];?>;color:#FFF" data-toggle="tooltip" data-placement="bottom" title="<?= $tag['use_name']; ?>">
