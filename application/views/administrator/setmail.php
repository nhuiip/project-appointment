                                ...
                                <? foreach ($listdata as $key => $value) { ?>
                                    <tr class="gradeX">
                                        ...
                                        <td width="15%">
                                            ...
                                            <small class="text-muted"><i class="fa fa-clock-o"></i> <?= date('d/m/Y h:i A', strtotime($value['email_create_date'])); ?></small>
                                        </td>
                                        <td width="15%">
                                            <?= $value['email_lastedit_name']; ?><br />
                                            <small class="text-muted"><i class="fa fa-clock-o"></i> <?= date('d/m/Y h:i A', strtotime($value['email_lastedit_date'])); ?></small>
                                        </td>
                                        <td width="10%">
